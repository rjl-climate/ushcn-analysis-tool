...
def main():
    ...
    if data_dir.exists():
        ...
        if fls52_file.exists():
            print(
                f"✓ FLS52 file size: {fls52_file.stat().st_size / 1024 / 1024:.1f} MB"
            )
    ...
    try:
        ...
        print("✓ Successfully imported ushcn_heatisland.data.loaders")

        from ushcn_heatisland.urban.context import UrbanContextManager

        print("✓ Successfully imported ushcn_heatisland.urban.context")
