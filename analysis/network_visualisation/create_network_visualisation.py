...
from ushcn_heatisland.data_loader import load_station_locations, load_all_ushcn_stations
...
def main():
    ...
    try:
        ...
        print(f"  Figure size: 16×10 inches at 300 DPI")
        print(f"  Clean Tufte-style design with attribution")
